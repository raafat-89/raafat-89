...
const CONFIG = {
    ...
    SCAN_INTERVAL: 90000, // دورة الفحص الكاملة كل 90 ثانية (أسرع وقت ممكن ومستقر)
    REPORT_INTERVAL: 300000, // إرسال تقرير كل 5 دقائق
    REQUIRED_DISCOUNT: 3, // <-- تم التعديل هنا إلى 3%
...
app.get("/", (req, res) => res.send('Expanded P2P Bot v3.1 is alive!'));
app.listen(PORT, () => {
    console.log(`Server running on port ${PORT}`);
    safeSendMessage(`✅ **النسخة 3.1 (خصم ${CONFIG.REQUIRED_DISCOUNT}%) بدأت العمل!**`);
});
