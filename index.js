...
const CONFIG = {
    ...
    SCAN_INTERVAL: 75000, // دورة فحص سريعة ومستقرة كل 75 ثانية
    REQUIRED_DISCOUNT: 3,
...
const client = axios.create({ httpsAgent: agent, httpAgent: agent, timeout: 15000 });
...
app.get("/", (req, res) => res.send('P2P Golden Bot v6.0 is alive!'));
app.listen(PORT, () => {
    console.log(`Server running on port ${PORT}`);
    safeSendMessage(`✅ **النسخة الذهبية v6.0 بدأت العمل!**\nأرسل /report للحصول على تقرير.`);
});
