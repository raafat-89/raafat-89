...
const CONFIG = {
    ...
    REQUIRED_DISCOUNT: 3, // نسبة الخصم التي اتفقنا عليها
...
app.get("/", (req, res) => res.send('P2P Bot 5x5 Version is alive!'));
app.listen(PORT, () => {
    console.log(`Server running on port ${PORT}`);
    safeSendMessage(`✅ **النسخة النهائية 5x5 بدأت العمل!**`);
});
